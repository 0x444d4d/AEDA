...
exe 'vert 2resize ' . ((&columns * 124 + 119) / 239)
argglobal
...
silent! normal! zE
let s:l = 41 - ((29 * winheight(0) + 30) / 60)
...
wincmd w
argglobal
if bufexists("~/Documents/C++/AEDA/p5/inc/sortQuick.hpp") | buffer ~/Documents/C++/AEDA/p5/inc/sortQuick.hpp | else | edit ~/Documents/C++/AEDA/p5/inc/sortQuick.hpp | endif
xnoremap <buffer> <silent> \a] `>a]`<i[
xnoremap <buffer> <silent> \a[ `>a]`<i[
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
exe 'vert 2resize ' . ((&columns * 124 + 119) / 239)
tabnext 1
badd +60 ~/Documents/C++/AEDA/p5/inc/sortQuick.hpp
badd +0 ~/Documents/C++/AEDA/p5/inc/sortMerge.hpp
