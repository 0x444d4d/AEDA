...
wincmd w
argglobal
if bufexists("~/Documents/C++/AEDA/p5/inc/dni-t.hpp") | buffer ~/Documents/C++/AEDA/p5/inc/dni-t.hpp | else | edit ~/Documents/C++/AEDA/p5/inc/dni-t.hpp | endif
xnoremap <buffer> <silent> \a] `>a]`<i[
xnoremap <buffer> <silent> \a[ `>a]`<i[
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
wincmd w
argglobal
if bufexists("~/Documents/C++/AEDA/p5/NetrwTreeListing\ 4") | buffer ~/Documents/C++/AEDA/p5/NetrwTreeListing\ 4 | else | edit ~/Documents/C++/AEDA/p5/NetrwTreeListing\ 4 | endif
xnoremap <buffer> <silent> \a] `>a]`<i[
xnoremap <buffer> <silent> \a[ `>a]`<i[
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
exe 'vert 3resize ' . ((&columns * 119 + 119) / 239)
tabnext 1
badd +1 ~/Documents/C++/AEDA/p5/inc/dni-t.hpp
