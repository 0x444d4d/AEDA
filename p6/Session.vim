...
exe 'vert 1resize ' . ((&columns * 109 + 119) / 239)
exe '2resize ' . ((&lines * 30 + 31) / 62)
exe 'vert 2resize ' . ((&columns * 109 + 119) / 239)
exe 'vert 3resize ' . ((&columns * 108 + 119) / 239)
exe 'vert 4resize ' . ((&columns * 20 + 119) / 239)
argglobal
...
silent! normal! zE
let s:l = 86 - ((14 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
normal! 0
lcd ~/Documents/C++/AEDA/p6
wincmd w
argglobal
if bufexists("~/Documents/C++/AEDA/p6/main.cpp") | buffer ~/Documents/C++/AEDA/p6/main.cpp | else | edit ~/Documents/C++/AEDA/p6/main.cpp | endif
xnoremap <buffer> <silent> \a] `>a]`<i[
xnoremap <buffer> <silent> \a[ `>a]`<i[
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
wincmd w
argglobal
if bufexists("~/Documents/C++/AEDA/p6/bbtree.hpp") | buffer ~/Documents/C++/AEDA/p6/bbtree.hpp | else | edit ~/Documents/C++/AEDA/p6/bbtree.hpp | endif
xnoremap <buffer> <silent> \a] `>a]`<i[
xnoremap <buffer> <silent> \a[ `>a]`<i[
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
argglobal
enew
file ~/Documents/C++/AEDA/p6/vim-minimap
xnoremap <buffer> <silent> \a] `>a]`<i[
xnoremap <buffer> <silent> \a[ `>a]`<i[
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
exe 'vert 4resize ' . ((&columns * 20 + 119) / 239)
tabnext 1
badd +102 ~/Documents/C++/AEDA/p6/main.cpp
badd +44 ~/Documents/C++/AEDA/p6/bbtree.hpp
badd +92 ~/Documents/C++/AEDA/p6/dni.hpp
